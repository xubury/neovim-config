...
local on_attach = function(client, bufnr)
    ...
    u.map("n", "rn", "<cmd>Lspsaga rename<CR>", opts)
    u.map("n", "ca", "<cmd>Lspsaga code_action<CR>", opts)
    u.map("n", "gr", "<cmd>Lspsaga lsp_finder<CR>", opts)
    u.map("n", "<space>e", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
    u.map("n", "gp", "<cmd>Lspsaga diagnostic_jump_prev<CR>", opts)
    u.map("n", "gn", "<cmd>Lspsaga diagnostic_jump_next<CR>", opts)
